$(document).ready(function() {
				...
				$.post('./sendforms.php', {
					...
					function(data){
						...
						if(data==0)
						{
							...
							yaCounter54200941.reachGoal('OFFER_SEND');
				...
				$.post('./sendforms.php', {
					...
					function(data){
						...
						if(data==0)
						{
							...
							yaCounter54200941.reachGoal('CALLBACK_SEND');
				...
				$.post('./sendforms.php', {
					...
					function(data){
						...
						if(data==0)
						{
							...
							yaCounter54200941.reachGoal('CAR_RESERV_SEND');
	...
	$("body").on("click",'.getleadcallorder',  function(e){
		...
		yaCounter54200941.reachGoal('CALLBACK_CLICK');
	...
	$("body").on("click",'.getleadspinoff',  function(e){
		...
		yaCounter54200941.reachGoal('CAR_RESERV_CLICK');
	...
	$("body").on("click",'[lpage]',  function(e){
		...
		yaCounter54200941.reachGoal('CLICK_STOCK');
